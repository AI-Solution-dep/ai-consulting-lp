        ...
        <div className="comparison-table-wrap">
          <table className="comparison-table">
            ...
            <tbody>
              ...
              <tr><th scope="row">対象業務</th><td data-label="AI研修・QAボット導入">汎用的な文章作成・要約・社内FAQが中心。</td><td data-label="JQIT 業務自動化支援">議事録、報告書、集計、書類チェックなど、貴社の具体業務そのもの。</td></tr>
              <tr><th scope="row">成果物</th><td data-label="AI研修・QAボット導入">説明資料、プロンプト例、QAデータ。</td><td data-label="JQIT 業務自動化支援">貴社専用のエージェントスキル、自動化スクリプト、運用ルール、AI導入ロードマップ。</td></tr>
              <tr><th scope="row">効果の見え方</th><td data-label="AI研修・QAボット導入">便利だが、削減工数が見えづらいことがある。</td><td data-label="JQIT 業務自動化支援">資料の作成時間、確認漏れ、集計の手間などで測定しやすい。</td></tr>
