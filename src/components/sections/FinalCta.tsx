  ...
  return (
    <section className="cta" id="cta" aria-labelledby="cta-title">
      <div className="container">
        ...
        <h2 id="cta-title">30分で、<br /><span className="keep-together">自動化の糸口を整理</span>。</h2>
        <p>いま使っているアプリと、減らしたい手作業を一緒に整理します。<br />対象テーマが未定でも、業務名だけで相談できます。<small>30分・オンライン・準備物なし／営業電話・しつこいフォローはありません。</small></p>
        <p className="cta-checklist__title">無料相談で整理する3つのこと</p>
